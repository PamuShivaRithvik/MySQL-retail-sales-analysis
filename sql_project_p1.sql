...
-- Data analysis & Businees key probel and solution
...
-- Q.5 Write a SQL query to find all transactions where the total_sale is greater than or equal to 1000(ascending order)
SELECT *
FROM retail_sales
...
SELECT YEAR(sale_date), MONTH(sale_date), AVG(total_sale) AS avg_sale
FROM retail_sales
